...
<section class="profile-section">
    ...
    <div class="profile-grid">
        ...
        <div class="profile-card full-width">
            <h3><i class='bx bx-lock-alt'></i> Security</h3>
            ...
            <form action="" method="POST">
                ...
                <input type="submit" name="submit" value="Change Password" class="btn-auth" style="margin-top: 26px;">
            </form>
        </div>

        <!-- Order History Card -->
        <div class="profile-card full-width">
            <h3><i class='bx bx-package'></i> Recent Orders</h3>
            ...
            if ($order_count > 0) {
                ...
                <table class="order-history-table">
                    ...
                    <?php while ($order = mysqli_fetch_assoc($order_res)): ?>
                        <tr>
                            ...
                            <td style="font-weight: 600; color: #155e58;">৳<?php echo $order['total']; ?></td>
                ...
                <br>
                <div class="auth-link">
                    <a href="<?php echo SITEURL; ?>customer/my-orders.php"
                        style="display: inline-flex; align-items: center; gap: 4px;">View All Orders <i
                            class='bx bx-right-arrow-alt'></i></a>
                </div>
                <?php
            } else {
                echo "<p style='color:#888; text-align:center; padding:30px; background:#f8fafc; border-radius:8px;'>You haven't placed any orders yet.</p>";
            }
            ?>
        </div>
    </div>
