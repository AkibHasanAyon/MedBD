...
(12, 'Adminstrator', 'admin', '$2y$10$Z1z8EKFGck6GWFv7SdypK.AUdO7/8UzrgQb7pBo0r/XmlZBj0wcWq'),
...
INSERT INTO `tbl_order` (`id`, `customer_id`, `product_id`, `product`, `price`, `qty`, `total`, `order_date`, `status`, `payment_method`, `payment_status`, `prescription_image`, `customer_name`, `customer_contact`, `customer_email`, `customer_address`) VALUES
(7, NULL, 32, 'Blood Glucometer', 2300.00, 5, 11500.00, '2022-12-09 01:45:31', 'Ordered', 'Cash on Delivery', 'Pending', '', 'Rahat hasan', '445839579354', 'hasan34@gmail.com', '23/56 hazi danesh road ,dhaka'),
(8, NULL, 33, 'Blood Lancet Needles', 115.00, 5, 575.00, '2022-12-09 01:48:27', 'Cancelled', 'Cash on Delivery', 'Pending', '', 'rakib haque', '458234792', 'rakib345@gmail.com', '33/6 merul badda bus stand,Dhaka'),
(9, NULL, 35, 'Reusable Insulin Pen', 590.00, 1, 590.00, '2022-12-09 01:53:25', 'Delivered', 'Cash on Delivery', 'Pending', '', 'dalim sorkar', '0138459834', 'dalim345@yahoo.com', '23/7 north badda station road ,Dhaka'),
(10, NULL, 36, 'Thermometer Digital LCD', 120.00, 1, 120.00, '2022-12-09 01:56:36', 'On Delivery', 'Cash on Delivery', 'Pending', '', 'nazrul islam', '0183456-765', 'nazrul562@gmail.com', '23/90  mohshin hasan sorok,malibag ,Dhaka'),
(11, NULL, 21, 'Jhonson\'s Baby Shampoo', 299.00, 1, 299.00, '2022-12-11 01:29:39', 'On Delivery', 'Cash on Delivery', 'Pending', '', 'sahil', '123456789', 'sahil@gmail.com', 'bashundara\'s'),
(12, NULL, 28, 'Pampers', 1599.00, 1, 1599.00, '2022-12-12 01:47:21', 'Ordered', 'Cash on Delivery', 'Pending', '', 'alif', '034233241', 'alif@gmail.com', '3/1 Danmondi'),
(13, NULL, 23, 'Kids Brush', 350.00, 1, 350.00, '2022-12-18 09:07:38', 'Ordered', 'Cash on Delivery', 'Pending', '', 'Akib Hasan', '01516784700', 'vondo99baba@gmail.com', '287/A, shantibag, dhaka.'),
(14, 1, 23, 'Kids Brush', 350.00, 2, 700.00, '2026-06-22 07:44:28', 'Delivered', 'Cash on Delivery', 'Pending', '', 'Akib Hasan', '01746585025', 'ayon.isc@gmail.com', '287/A, Shantibag'),
(15, 1, 36, 'Thermometer Digital LCD', 120.00, 1, 120.00, '2026-06-22 08:21:41', 'Ordered', 'Stripe', 'Paid', '', 'Akib Hasan', '01746585025', 'ayon.isc@gmail.com', '287/A, Shantibag');
...
ALTER TABLE `tbl_cart`
  ...
  ADD CONSTRAINT `tbl_cart_ibfk_2` FOREIGN KEY (`product_id`) REFERENCES `tbl_product` (`id`) ON DELETE CASCADE;
...
--
ALTER TABLE `tbl_review`
  ADD CONSTRAINT `tbl_review_ibfk_1` FOREIGN KEY (`product_id`) REFERENCES `tbl_product` (`id`) ON DELETE CASCADE,
  ADD CONSTRAINT `tbl_review_ibfk_2` FOREIGN KEY (`customer_id`) REFERENCES `tbl_customer` (`id`) ON DELETE CASCADE;

--
-- Constraints for table `tbl_wishlist`
--
ALTER TABLE `tbl_wishlist`
  ADD CONSTRAINT `tbl_wishlist_ibfk_1` FOREIGN KEY (`customer_id`) REFERENCES `tbl_customer` (`id`) ON DELETE CASCADE,
  ADD CONSTRAINT `tbl_wishlist_ibfk_2` FOREIGN KEY (`product_id`) REFERENCES `tbl_product` (`id`) ON DELETE CASCADE;
COMMIT;
